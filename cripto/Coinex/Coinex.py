...
class Coinex:
    def __init__(self):
        ...
        self.base_url = self.web_data["Coinex"]["url"]
        self.all_tickers = self.web_data["Coinex"]["all_tickers"]
        self.all_name_tickers = self.web_data["Coinex"]["all_name_tickers"]
        self.ticker_price = self.web_data["Coinex"]["ticker_price"]
        self.commission = self.web_data["Coinex"]["commission"]
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = fr"Coinex\response_{self.urls.index(url)}.json"
