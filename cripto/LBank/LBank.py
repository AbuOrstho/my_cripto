...
class LBank:
    def __init__(self):
        ...
        self.all_tickers = self.web_data["LBank"]["all_tickers"]
        self.all_name_tickers = self.web_data["LBank"]["all_name_tickers"]
        self.ticker_price = self.web_data["LBank"]["ticker_price"]
        self.commission = self.web_data["LBank"]["commission"]
    ...
    async def fetch(self, session, url):
        ...
        async with session.get(url) as response:
            ...
            filename = fr"LBank\response_{self.urls.index(url)}.json"
